# This an optional custom initial jdtls script enhacement
# that allows for lombok support in java related projects. 
# Consider only using this if you need lombok support.
#
# Depending on installation, this script should be
...
def main(args):
	...
	lombok_path = jdtls_base_path / "lombok.jar"
